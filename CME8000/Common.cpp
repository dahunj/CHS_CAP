...
#ifdef CHS_KS
	if (!pDX06->iLoadPickerUp02 || pDX06->iLoadPickerDown02) { gAlm.nLDPickerNo = 1; return FALSE; }
	if (!pDX06->iLoadPickerUp03 || pDX06->iLoadPickerDown03) { gAlm.nLDPickerNo = 2; return FALSE; }
	if (!pDX06->iLoadPickerUp04 || pDX06->iLoadPickerDown04) { gAlm.nLDPickerNo = 3; return FALSE; }
	if (!pDX06->iLoadPickerUp05 || pDX06->iLoadPickerDown05) { gAlm.nLDPickerNo = 4; return FALSE; }
#endif
...
#ifdef CHS_KS
	if (nNo == 0 || nNo == 1) pDY06->oLoadPickerDown02 = TRUE;
	if (nNo == 0 || nNo == 2) pDY06->oLoadPickerDown03 = TRUE;
	if (nNo == 0 || nNo == 3) pDY06->oLoadPickerDown04 = TRUE; 
	if (nNo == 0 || nNo == 4) pDY06->oLoadPickerDown05 = TRUE; 
...
BOOL CCommon::Get_LoadPickerDown(int nNo)
{
	...
	else if (nNo ==  1 && (pDX06->iLoadPickerUp02 || !pDX06->iLoadPickerDown02)) { gAlm.nLDPickerNo = 1; return FALSE; }
	else if (nNo ==  2 && (pDX06->iLoadPickerUp03 || !pDX06->iLoadPickerDown03)) { gAlm.nLDPickerNo = 2; return FALSE; }
	else if (nNo ==  3 && (pDX06->iLoadPickerUp04 || !pDX06->iLoadPickerDown04)) { gAlm.nLDPickerNo = 3; return FALSE; }
	else if (nNo ==  4 && (pDX06->iLoadPickerUp05 || !pDX06->iLoadPickerDown05)) { gAlm.nLDPickerNo = 4; return FALSE; }
...
#ifdef CHS_KS
	if (!pDX06->iLoadPickerOpen02) { gAlm.nLDPickerNo = 1; return FALSE; }
	if (!pDX06->iLoadPickerOpen03) { gAlm.nLDPickerNo = 2; return FALSE; }
	if (!pDX06->iLoadPickerOpen04) { gAlm.nLDPickerNo = 3; return FALSE; }
	if (!pDX06->iLoadPickerOpen05) { gAlm.nLDPickerNo = 4; return FALSE; }
#endif
	return TRUE;
}
...
#ifdef CHS_KS
	if (pDX06->iLoadPickerCMCheck02) { gAlm.nLDPickerNo = 1; return FALSE; }
	if (pDX06->iLoadPickerCMCheck03) { gAlm.nLDPickerNo = 2; return FALSE; }
	if (pDX06->iLoadPickerCMCheck04) { gAlm.nLDPickerNo = 3; return FALSE; }
	if (pDX06->iLoadPickerCMCheck05) { gAlm.nLDPickerNo = 4; return FALSE; }
#endif
...
#ifdef CHS_KS
	if (nNo == 1) {
		if (nCnt > 0 && (pDX06->iLoadPickerUp02 || !pDX06->iLoadPickerDown02)) { gAlm.nLDPickerNo = 1; return FALSE; }
		if (nCnt > 1 && (pDX06->iLoadPickerUp03 || !pDX06->iLoadPickerDown03)) { gAlm.nLDPickerNo = 2; return FALSE; }
		if (nCnt > 2 && (pDX06->iLoadPickerUp04 || !pDX06->iLoadPickerDown04)) { gAlm.nLDPickerNo = 3; return FALSE; }
		if (nCnt > 3 && (pDX06->iLoadPickerUp05 || !pDX06->iLoadPickerDown05)) { gAlm.nLDPickerNo = 4; return FALSE; }


	}
	else if (nNo == 2) {
		if (nCnt > 0 && (pDX06->iLoadPickerUp03 || !pDX06->iLoadPickerDown03)) { gAlm.nLDPickerNo = 2; return FALSE; }
		if (nCnt > 1 && (pDX06->iLoadPickerUp04 || !pDX06->iLoadPickerDown04)) { gAlm.nLDPickerNo = 3; return FALSE; }
		if (nCnt > 2 && (pDX06->iLoadPickerUp05 || !pDX06->iLoadPickerDown05)) { gAlm.nLDPickerNo = 4; return FALSE; }

	}
	else if (nNo == 3) {
		if (nCnt > 0 && (pDX06->iLoadPickerUp04 || !pDX06->iLoadPickerDown04)) { gAlm.nLDPickerNo = 3; return FALSE; }
		if (nCnt > 1 && (pDX06->iLoadPickerUp05 || !pDX06->iLoadPickerDown05)) { gAlm.nLDPickerNo = 4; return FALSE; }

	}
	else if (nNo == 4) {
		if (nCnt > 0 && (pDX06->iLoadPickerUp05 || !pDX06->iLoadPickerDown05)) { gAlm.nLDPickerNo = 4; return FALSE; }
...
#ifdef CHS_KS
	if (pInfo[0] > 0) pDY06->oLoadPickerDown02 = TRUE;
	if (pInfo[1] > 0) pDY06->oLoadPickerDown03 = TRUE;
	if (pInfo[2] > 0) pDY06->oLoadPickerDown04 = TRUE;
	if (pInfo[3] > 0) pDY06->oLoadPickerDown05 = TRUE;
#endif
...
#ifdef CHS_KS
	if (pInfo[0] > 0 && (pDX06->iLoadPickerUp02 || !pDX06->iLoadPickerDown02)) { gAlm.nLDPickerNo = 1; return FALSE; }
	if (pInfo[1] > 0 && (pDX06->iLoadPickerUp03 || !pDX06->iLoadPickerDown03)) { gAlm.nLDPickerNo = 2; return FALSE; }
	if (pInfo[2] > 0 && (pDX06->iLoadPickerUp04 || !pDX06->iLoadPickerDown04)) { gAlm.nLDPickerNo = 3; return FALSE; }
	if (pInfo[3] > 0 && (pDX06->iLoadPickerUp05 || !pDX06->iLoadPickerDown05)) { gAlm.nLDPickerNo = 4; return FALSE; }
#endif
...
#ifdef CHS_KS
	if (pInfo[0] > 0) pDY06->oLoadPickerGrip02 = TRUE;
	if (pInfo[1] > 0) pDY06->oLoadPickerGrip03 = TRUE;
	if (pInfo[2] > 0) pDY06->oLoadPickerGrip04 = TRUE;
	if (pInfo[3] > 0) pDY06->oLoadPickerGrip05 = TRUE;
#endif
...
#ifdef CHS_KS
	if (pInfo[0] > 0 && pDX06->iLoadPickerOpen02) { gAlm.nLDPickerNo = 1; return FALSE; }
	if (pInfo[1] > 0 && pDX06->iLoadPickerOpen03) { gAlm.nLDPickerNo = 2; return FALSE; }
	if (pInfo[2] > 0 && pDX06->iLoadPickerOpen04) { gAlm.nLDPickerNo = 3; return FALSE; }
	if (pInfo[3] > 0 && pDX06->iLoadPickerOpen05) { gAlm.nLDPickerNo = 4; return FALSE; }
#endif
...
#ifdef CHS_KS
	if (pInfo[0] > 0 && !pDX06->iLoadPickerCMCheck02) { gAlm.nLDPickerNo = 1; return FALSE; }
	if (pInfo[1] > 0 && !pDX06->iLoadPickerCMCheck03) { gAlm.nLDPickerNo = 2; return FALSE; }
	if (pInfo[2] > 0 && !pDX06->iLoadPickerCMCheck04) { gAlm.nLDPickerNo = 3; return FALSE; }
	if (pInfo[3] > 0 && !pDX06->iLoadPickerCMCheck05) { gAlm.nLDPickerNo = 4; return FALSE; }
#endif
